...
namespace AshLight.BakerySim
{
    public class CustomerManager : MonoBehaviour
    {
        ...
        private Customer CreateCustomer()
        {
            ...
            Transform visualTransform = Instantiate(customerVisualPrefab, customerTransform.position,
                customerTransform.rotation, customerTransform);
            ...
            foreach (CheckoutStation checkout in CheckoutStations.Where(checkout => checkout.IsAvailable()))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        float distanceToSelectedCheckout =
                            Vector3.Distance(customerPosition, selectedCheckout.transform.position);
